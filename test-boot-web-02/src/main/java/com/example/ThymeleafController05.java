...
@Controller
public class ThymeleafController05 {
	...
	@RequestMapping(value = "/05-enquiry-sample", method = RequestMethod.GET)
	public String getAsKeyValue(Model model) {
		...
		return "simple/05-enquiry-sample";
	}
	
	@RequestMapping(value = "/05-enquiry-sample", method = RequestMethod.POST)
